...
export const FEATURED_PLAYLISTS: FeaturedPlaylist[] = [
  {
    ...
    description:
      "The biggest global chartbusters and streaming sensations right now.",
    cover:
  ...
  },
  {
    ...
    description:
      "Soulful Hindi melodies, chart-topping romantic ballads, and club anthems.",
    cover:
  ...
  },
  {
    ...
    description:
      "High-octane blockbusters and soulful tracks across Tamil, Telugu, and Malayalam.",
    cover:
  ...
  },
  {
    ...
    description:
      "Energetic Bhangra anthems, urban Punjabi rap, and bass-boosted party bangers.",
    cover:
  ...
  },
  {
    ...
    description:
      "Addictive electronic hooks, nostalgic synthwave, and chart-topping dance anthems.",
    cover:
  ...
  },
  {
    ...
    description:
      "The hardest 808s, lyrical storytelling, drill bangers, and global rap royalty.",
    cover:
  ...
  },
  {
    ...
    description:
      "High-BPM electro, motivational beats, and festival anthems for peak performance.",
    cover:
  ...
  },
  {
    ...
    description:
      "Iconic electric guitar riffs, alternative indie melodies, and stadium rock legends.",
    cover:
  ...
  },
  {
    ...
    description:
      "Peaceful acoustic guitar, unplugged vocals, and serene nighttime instrumentals.",
    cover:
...
export function getFeaturedPlaylistById(
  id: string,
